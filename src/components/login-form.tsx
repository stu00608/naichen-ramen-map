...
export function LoginForm({
	...
	const isTooManyRequestsError =
		error.includes("登入嘗試次數過多") || error.includes("too-many-requests");
		...
		<div className={cn("flex flex-col gap-6 w-[400px]", className)} {...props}>
			<Card>
				<CardHeader>
					...
					<CardDescription>登入以新增、修改拉麵店及評價資料</CardDescription>
				</CardHeader>
				<CardContent>
					{error && (
			...
			<Dialog open={isInviteDialogOpen} onOpenChange={setIsInviteDialogOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>請輸入邀請碼以完成註冊</DialogDescription>
					</DialogHeader>
